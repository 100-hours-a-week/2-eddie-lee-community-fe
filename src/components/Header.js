...
const ProjectTitle = () => {
    return <HeaderTitle>감성적인 엔지니어</HeaderTitle>;
};
    ...
    return (
        <UserProfileBox onClick={handleClick}>
            ...
            <Dropdown isClicked={isClicked}>
                <DropdownContent onClick={handleEditUser}>
                    회원정보수정
                </DropdownContent>
                <DropdownContent onClick={handleEditUserPasswd}>
                    비밀번호수정
                </DropdownContent>
...
function Header({ pathName }) {
    ...
    return (
        headerComponent[pathName] || <GetAllHeader profileImg={profileImg} />
    );
}
