...
const LoginTitle = () => {
    return <LoginTitleStyle>로그인</LoginTitleStyle>;
};

const InputEmailLabel = () => {
    return <InputLabel label="이메일" />;
};
...
function Login() {
    ...
    const [passwdHelperText, setPasswdHelperText] =
                ...
                if (loginResponse.ok) {
                    try {
                        ...
                        if (userData.profileImg) {
                            setProfileImg(getImgURL(userData.profileImg));
                        } else {
    ...
    return (
        <LoginArticle>
            ...
            <InputEmailLabel />
            <InputField
                inputListener={handleEmailChange}
                value={email}
            ...
            <InputPasswdLabel />
            <InputField
                inputListener={handlePasswordChange}
                value={password}
